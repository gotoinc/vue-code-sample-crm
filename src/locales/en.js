export const en = {
  ...
  menu: {
    menuAccount: "Account",
    menuHistory: "Record history",
    menuPlanning: "Planning",
    menuNewRecord: "New Record",
  ...
  messages: {
    ...
    first_login: "You should login first",
    system_logout: "You logged out from the system",
    create_new_record_tooltip: "Create new record",
    more_than: "You have exceeded the limit by",
